        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what){
                case VIDEO_PLAY_UPDATAVIEW:
                    //得到当前播放进度
                    int currentPosition = video_play.getCurrentPosition();
...
//                    prePosition=currentPosition;
                ...
                case HIDE_MEDIACONTROLLER:
                    ...
                    //每秒更新网速
                case SHOW_SPEED:
                    String netSpeed = netUriUtils.getNetSpeed(SystemVideoPlayer.this);
    ...
    private void setPlayPre() {
        if(mediaItemList!=null&&mediaItemList.size()>0){
            ...
            if(position>=0){
                ...
                if(position==0){
                    Toast.makeText(SystemVideoPlayer.this,"第一个视频",Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
        ...
        if(mediaItemList!=null&&mediaItemList.size()>0){
            ...
            if(position<mediaItemList.size()){
                ...
                if(position==mediaItemList.size()-1){
                    Toast.makeText(SystemVideoPlayer.this,"最好一个视频",Toast.LENGTH_SHORT).show();
                }
            }else{ //播放最后一个退出播放器
                finish();
            }
    ...
    private void setListener() {
        ...
        video_play.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mediaPlayer) {
                ...
                int duration = mediaPlayer.getDuration();//或int duration1 = video_play.getDuration();
...
//                video_play.setVideoSize(300,200);
        ...
        video_play.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mediaPlayer, int i, int i1) {
                ...
                //出错时显示AlertDialog提示
//                new AlertDialog
//                        .Builder(SystemVideoPlayer.this)
//                        .setTitle("提示")
//                        .setMessage("播放视频出错，请检查网络或者视频是否有缺损！")
...
//                        }).setCancelable(false).show();
                ...
                //出错的原因：
                //1.播放不支持的视频格式    解决方法：跳转到万能播放器
               startVitamioPlayer();//集成Vitamio有报错待解决
                //2.播放网络视频过程中网络中断     解决方法：重新播放（在界面来个刷新，重走生命周期）
                //3.视频文件中间部分有缺损     解决方法：把下载模块解决掉
    ...
    private void startVitamioPlayer() {
        ...
        Toast.makeText(this,"启用万能播放器播放",Toast.LENGTH_SHORT).show();
